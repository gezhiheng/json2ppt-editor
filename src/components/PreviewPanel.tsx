...
export function PreviewPanel({
  ...
  return (
    <section
      ref={previewRef}
      className="preview-scroll flex min-h-0 flex-col gap-6 overflow-y-auto overflow-x-hidden rounded-xl border border-white/70 bg-white/80 p-6 shadow-soft backdrop-blur"
    >
