...
export async function getTableCellParams(tcNode: any, thisTblStyle: any, cellSource: any, warpObj: any) {
...
export function getTableRowParams(trNodes: any, i: any, tblStylAttrObj: any, thisTblStyle: any, warpObj: any) {
  let fillColor
  let fontColor
  let fontBold
