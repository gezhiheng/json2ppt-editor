...
function shapeArc(cX: any, cY: any, rX: any, rY: any, stAng: any, endAng: any, isClose: any) {
  ...
  const condition = (a: any) => (increment > 0 ? a <= endAng : a >= endAng)
...
export function getShapePath(shapType: any, w: any, h: any, node: any) {
  let pathData = ''
    ...
    case 'cloudCallout':
      {
        ...
        const getArc = (startX: any, startY: any, rX: any, rY: any, sA: any, wA: any) => {
