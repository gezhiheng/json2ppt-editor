...
export function genTextBody(textBodyNode: any, spNode: any, slideLayoutSpNode: any, slideMasterSpNode: any, type: any, warpObj: any) {
...
export function getListType(node: any) {
...
export function getListLevel(node: any) {
  const pPrNode = node['a:pPr']
  if (!pPrNode) return -1
...
export function genSpanElement(node: any, pNode: any, textBodyNode: any, pFontStyle: any, slideLayoutSpNode: any, slideMasterSpNode: any, type: any, warpObj: any) {
...
export function getSpanStyleInfo(node: any, pNode: any, textBodyNode: any, pFontStyle: any, slideLayoutSpNode: any, slideMasterSpNode: any, type: any, warpObj: any) {
